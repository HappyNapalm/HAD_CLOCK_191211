...
#define DEMO_USER_WAKEUP_KEY_PORT BOARD_S1_GPIO_PORT
#define DEMO_USER_WAKEUP_KEY_PIN BOARD_S1_GPIO_PIN
...
#define DEMO_PINT_PIN_INT0_SRC kSYSCON_GpioPort0Pin13ToPintsel
#define DEMO_WKT_CLK_FREQ (10000U)
#define DEMO_SLEEP_WAKEUP_SOURCE "\t1. S1, wakeup key\r\n\t2. Wkt timer\r\n\t3. S3, reset key\r\n"
#define DEMO_DEEP_SLEEP_WAKEUP_SOURCE "\t1. S1, wakeup key\r\n\t2. Wkt timer\r\n\t3. S3, reset key\r\n"
#define DEMO_POWER_DOWN_WAKEUP_SOURCE "\t1. S1,wakeup key\r\n\t2. Wkt timer\r\n\t3. S3, reset key\r\n"
#define DEMO_DEEP_POWERDOWN_WAKEUP_SOURCE "\t1. S1,wakeup key\r\n"
